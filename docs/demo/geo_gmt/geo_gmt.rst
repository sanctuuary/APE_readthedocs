...
As an example, if you would download the `APE-2.5.2-executable.jar 
<https://repo.maven.apache.org/maven2/io/github/sanctuuary/APE/2.5.2/APE-2.5.2-executable.jar>`_ 
